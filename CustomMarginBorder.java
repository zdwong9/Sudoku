...
class CustomBorder extends AbstractBorder {
    ...
    public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
        ...
        if (g instanceof Graphics2D) {
            ...
            // // Left Border
            // g2d.draw(new Line2D.Double((double) x, (double) y, (double) x, (double) y + 100));
            // g2d.draw(new Line2D.Double((double) x + 10, (double) y + 10, (double) x + 20,
            //         (double) y + 10));
            // // Right Border
            // g2d.draw(new Line2D.Double((double) width - 10, (double) y + 10, (double) width - 10, (double) y + 100));
